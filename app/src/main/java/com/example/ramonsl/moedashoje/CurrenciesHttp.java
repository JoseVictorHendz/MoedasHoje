...
public class CurrenciesHttp {
    ...
    public static Stocks getStocksFromJson(JSONObject json){
        ...
        try {
            ...
            variation= json.getString("variation");
            bolsas = new Stocks(name, location,variation);
        }catch (JSONException ex){
            Log.d("ERROR",ex.getMessage());
        }
        return bolsas;
...
public static ArrayList<Stocks> readJsonStocks(JSONObject json){
    ...
    try {
        ...
        Stocks stocks = new Stocks(ibovespa.getString("name"),ibovespa.getString("location"),ibovespa.getString("variation"));
